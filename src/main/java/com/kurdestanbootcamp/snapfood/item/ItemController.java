...
import com.kurdestanbootcamp.snapfood.common.PagingData;
...
public class ItemController {
    ...
    public ResponseEntity<List<ItemDTO>> getAllBySupplier(@PathVariable Long supplierId){
        List<Item> items= itemService.getAllBySupplierCategory_Supplier(supplierId);
        List<ItemDTO> itemDTOS = itemMapper.toItemDTOS(items);
